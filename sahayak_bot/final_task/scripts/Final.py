...
if __name__ == '__main__':
    try:
        ...
        # rospy.loginfo("Fixed Position")
        # while not rospy.is_shutdown():
            # ur5.set_joint_angles(pantry_point_cloud)
            # break
...
# final height - 1.081254198886
        # Tilted Hand orientation
        ...
        ur52_pose.position.x =0.405227+0.026
        ur52_pose.position.y = 0.058829+0.013
        ...
        # ur52_pose.orientation.x = -0.428257862206
        # ur52_pose.orientation.y = -0.570048695207
        # ur52_pose.orientation.z = 0.616024171641
        # ur52_pose.orientation.w = 0.334893876483

        ur52_pose_final.position.x = 0.405227+0.026
        ur52_pose_final.position.y = 0.058829+0.013
        ...
        # ur52_pose_final.orientation.x = -0.428257862206
        # ur52_pose_final.orientation.y = -0.570048695207
        # ur52_pose_final.orientation.z = 0.616024171641
        # ur52_pose_final.orientation.w = 0.334893876483

        # rospy.loginfo(x1)
        while not rospy.is_shutdown():
            ur5.set_joint_angles(pick_before)
            ur52.go_to_pose(ur52_pose)
            break

        # result = movebase_client(11.15,-0.9)
        # rospy.loginfo("Fixed Robot Position")
        ...
        # rospy.loginfo("Fixed Robot Position")
        # result = movebase_client(13.1,-0.9)
        # rospy.loginfo("Reached Center Position")

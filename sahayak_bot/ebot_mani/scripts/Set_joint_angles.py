...
def main():
    ...
    container_3= [math.radians(-92),
                          math.radians(-45),
                          math.radians(60),
                          math.radians(-99),
                          math.radians(-85),
                          math.radians(0)]
    container_4= [math.radians(-103),
                          math.radians(-54),
                          math.radians(60),
                          math.radians(-88),
                          math.radians(-85),
    ...
    while not rospy.is_shutdown():
        ur5.set_joint_angles(soap)
        ur51.go_to_predefined_pose("mid3")
        ur5.set_joint_angles(container_1)
        ur51.go_to_predefined_pose("open")
        ur5.set_joint_angles(soap_2)
        ur51.go_to_predefined_pose("mid5")
        ur5.set_joint_angles(container_2)
        ur51.go_to_predefined_pose("open")
        ur5.set_joint_angles(pos1)
        ur5.set_joint_angles(pos2)
        ur5.set_joint_angles(pos5)
        ur51.go_to_predefined_pose("mid2")
        ur5.set_joint_angles(container_4)
        ur51.go_to_predefined_pose("open")
        break
    del ur5
    del ur51

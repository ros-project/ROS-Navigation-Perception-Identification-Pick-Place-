...
perception_launch = roslaunch.parent.ROSLaunchParent(node_uuid, ["/home/lonewolf/catkin_ws/src/sahayak_bot/ebot_description/launch/original_perception.launch"])
roslaunch.configure_logging(node_uuid)

node_uuid1 = roslaunch.rlutil.get_or_generate_uuid(None, False)
perception_launch1 = roslaunch.parent.ROSLaunchParent(node_uuid1, ["/home/lonewolf/catkin_ws/src/sahayak_bot/ebot_description/launch/original_perception.launch"])
roslaunch.configure_logging(node_uuid1)

node_uuid2 = roslaunch.rlutil.get_or_generate_uuid(None, False)
perception_launch2= roslaunch.parent.ROSLaunchParent(node_uuid2, ["/home/lonewolf/catkin_ws/src/sahayak_bot/ebot_description/launch/original_perception.launch"])
roslaunch.configure_logging(node_uuid2)

uuid = roslaunch.rlutil.get_or_generate_uuid(None, False)
launch = roslaunch.parent.ROSLaunchParent(uuid, ["/home/lonewolf/catkin_ws/src/sahayak_bot/ebot_description/launch/some.launch"])
roslaunch.configure_logging(uuid)

uuid_1 = roslaunch.rlutil.get_or_generate_uuid(None, False)
launch_1 = roslaunch.parent.ROSLaunchParent(uuid_1, ["/home/lonewolf/catkin_ws/src/sahayak_bot/ebot_description/launch/some.launch"])
roslaunch.configure_logging(uuid_1)

uuid1 = roslaunch.rlutil.get_or_generate_uuid(None, False)
launch1 = roslaunch.parent.ROSLaunchParent(uuid1, ["/home/lonewolf/catkin_ws/src/sahayak_bot/ebot_description/launch/some.launch"])
roslaunch.configure_logging(uuid1)

uuid2 = roslaunch.rlutil.get_or_generate_uuid(None, False)
launch2 = roslaunch.parent.ROSLaunchParent(uuid2, ["/home/lonewolf/catkin_ws/src/sahayak_bot/ebot_description/launch/some.launch"])
...
# # # ---------------------Going To Detect Glue----------------------------------
        ...
        if tup1_glue[0][0]=="glue":
            ind=1
        if tup1_glue[1][0]=="glue":
            ind=2
        if tup1_glue[2][0]=="glue":
            ind=3
...
# # # # ---------------------Picking Up the Glue----------------------------------
  ...
  # w: 0.490554070887
        ...
        ur52_pose_4.position.x = x2+0.016
        ur52_pose_4.position.y = y2-0.300+0.005
        ur52_pose_4.position.z = 1.009192397391
        ...
        ur52_pose_5.position.x = x2+0.016
        ur52_pose_5.position.y = y2-0.200+0.005
        ...
        while not rospy.is_shutdown():
            ...
            ur51.go_to_predefined_pose("mid31")
            rospy.sleep(2)
            ur52.go_to_pose(ur52_pose_4)
            ur5.set_joint_angles(pos_center)
            break
...
# # # # # # ---------------------Picking fgpa-board----------------------------------
        ...
        index=-1
        tup1=Sort(tup)
        if tup1[0][0]=="fpga_board":
            index=1
        if tup1[1][0]=="fpga_board":
            index=2
        if tup1[2][0]=="fpga_board":
            index=3
        if tup1[3][0]=="fpga_board":
            index=4
        if tup1[4][0]=="fpga_board":
            index=5
        if tup1[5][0]=="fpga_board":
            index=6

        # For Moving Left
        if object_data[fpga][1]>=-0.3:
